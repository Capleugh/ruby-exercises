...
class StringTest < Minitest::Test
  ...
  def test_16
    ...
    # can also exclude parentheses. same goes for the next 4 test cases
    expected = 2
  ...
  def test_20
    ...
    # they all work separately but not together? Am I doing something wrong?
  end

  def test_21
    phrase = "   \n  \tto the    moon\n\n\t    "
    # In place of the line below, call a method to acheive the expected outcome
    # google how to remove white space
    actual = phrase.strip
